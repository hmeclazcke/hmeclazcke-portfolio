...
| SPEC-004 | Site Shell and Visual Foundation | Establish the common site structure, navigation foundation, and initial visual language used by the public portfolio. | Shared presentation foundation only. Feature-specific content remains in later specs. | SPEC-001 | in-progress |
