...
| SPEC-002 | Hello World Deployment | Validate the complete delivery path by publicly deploying a minimal page containing `Hello, world!` and Lorem Ipsum. | Validates frontend build, GitHub Actions and GitHub Pages deployment only. No real portfolio design or content. | SPEC-001 | in-progress |
