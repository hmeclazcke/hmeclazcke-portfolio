...
| SPEC-003 | Portfolio Data Model | Define the project-owned structured representation of technologies, contexts, projects, classifications, statuses, and relationships. | Defines data concepts and validation needs. Does not implement the final graph visualization. | SPEC-001 | in-progress |
