...
| SPEC-004 | Site Shell and Visual Foundation | Establish the common site structure, navigation foundation, and initial visual language used by the public portfolio. | Shared presentation foundation only. Feature-specific content remains in later specs. | SPEC-001 | done |
| SPEC-005 | Home | Build the main public entry experience and concise technical presentation. | Does not reproduce a traditional résumé or detailed professional history. | SPEC-004 | done |
| SPEC-006 | About Me | Present a personal but professionally focused introduction, including the intended use of personal visual material. | Does not duplicate LinkedIn professional history. | SPEC-004 | in-progress |
