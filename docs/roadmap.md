...
|---|---|---|---|---|---|
| SPEC-001 | Project Foundation | Establish the minimum frontend project foundation and development tooling required to begin implementation. | No real portfolio content or final UI. Must support producing a static deployment artifact compatible with the planned Phase 1 deployment model. | — | planned |
